...
TinyLink is a fast and modern URL Shortener built using Next.js App Router, Neon PostgreSQL, and TailwindCSS.
Create short links, track clicks, view statistics, and manage everything from a dashboard.
